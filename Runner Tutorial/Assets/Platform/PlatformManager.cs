...
public class PlatformManager : MonoBehaviour {
	...
	void Start () {
		...
		safetyNet = (Transform)Instantiate(prefab1);
	...
	void Update () {
		...
		if(safetyNet.localPosition.x < Runner.distanceTraveled) { 
			safetyNet.localPosition = new Vector3(Runner.distanceTraveled, -6, 0);	
		}
	}
